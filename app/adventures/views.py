...
def _rich_tasks(profile: Profile, state: dict, owner: int, chat: int) -> InputRichMessage:
    ...
    return InputRichMessage(
        html=(
            ...
            "<p>الـCombo يعني شكد يوم ورا بعض تكملون الستريك قبل 10 بالليل. "
            "كل يوم تلحقون قبل 10 يزيد ×1 ويعطيكم XP أكثر. "
            "إذا تأخرتوا بعد 10، فات يوم، أو احتاج الستريك حماية/إحياء، "
            "ينقطع ويرجع من البداية.</p>"
            "</details>"
            "<details><summary>الخيارات</summary>"
            + rich_buttons(
                owner,
